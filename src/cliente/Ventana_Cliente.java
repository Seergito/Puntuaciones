	...
	public Ventana_Cliente() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if(tf_puntuacion.getText().length()>0 && tf_nombre.getText().length()>0) {
					Puntuacion p=new Puntuacion(tf_nombre.getText(), Integer.valueOf(tf_puntuacion.getText()));
					//NO SE INSERTAR DATOS
				}else {
